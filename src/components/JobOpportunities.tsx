...
import { MapPin, DollarSign, Clock, Briefcase, Star, Filter, Search } from 'lucide-react';
...
const JobOpportunities: React.FC = () => {
  ...
  const jobListings = [
    ...
    },
    {
      ...
      requirements: ["AWS certification", "5+ years cloud experience", "Architecture design"],
    ...
    },
    {
      ...
      remote: true,
      posted: "3 days ago",
      description: "Help us build and maintain our CI/CD pipelines and infrastructure...",
